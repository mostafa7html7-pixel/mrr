const CACHE_NAME = 'abqarieno-v54'; // تحديث النسخة لضمان تحميل الصور والملفات الجديدة أوفلاين
const ASSETS = [ // تأكد من تحديث هذه القائمة لتشمل جميع الملفات الجديدة أو المعدلة
    ...
    './main.js',
    './firebase-config.js',
    // './6.jpeg', // تم تعطيلها مؤقتاً لمنع خطأ 404 وتعطل التخزين المؤقت
    './13.jpg', // صورة كتاب
    './14.png', // صورة كتاب
    './232.png', // صورة كتاب
    './212.png',
    ...
    './3.glb', // مجسم 3D
    './4.glb', // مجسم 3D
    './1.png', // Poster للمجسم 1
    './2.png', // Poster للمجسم 2 
    './3.png', // Poster للمجسم 3
    './4.png'  // Poster للمجسم 4
];
